...
1. **Start the Journey**: Enter the intro and select a character
2. **Explore the World**: Navigate the overworld map
3. **Make Choices**: Respond to spending encounters and events
4. **Learn & Track**: Use banking, investing, and library tools
5. **Review Outcomes**: Check the end-of-run summary
...
* **Bianca** - [Github](https://github.com/biancacchino) | [Linkedin](https://www.linkedin.com/in/biancajavier2006/)
* **Lori** - [Github](https://github.com/LoriB14) | [Linkedin](https://www.linkedin.com/in/lori-battouk-5905762b0/)
* **Tracy** - [Github](https://github.com/sutr4) | [Linkedin](https://www.linkedin.com/in/tracysu6/)

## 🙏 Acknowledgments

* Thanks to [ElleHacks](https://ellehacks.com/) for hosting the hackathon
